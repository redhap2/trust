...
reghdfe growth_country cvg_region_pot dist_cap_max_norm c.dist_cap_max_norm#c.cvg_region_pot dist_sndncap_max_norm $ind_controls if cvg_region_pot>.0272222 & spl==1, absorb(i.country_round) cluster(i.region_time)
...
graph export "${mypath}\plots\marginal_effect\pol_trust.png", width(4000) replace
*graph export "${mypath}\plots\marginal_effect\trust_inst_wo_low_cov.png", width(4000)

graph export "${mypath}\plots\marginal_effect\vote_oppo.png", width(4000)
*graph export "${mypath}\plots\marginal_effect\vote_oppo_wo_low_cov.png", width(4000)

*graph export "${mypath}\plots\marginal_effect\perf_country.png", width(4000)
*graph export "${mypath}\plots\marginal_effect\perf_country_wo_low_cov.png", width(4000)
