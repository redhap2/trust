...
#ggsave("murdock_map.jpg", width = 10, height = 6, dpi = 300)
...
```{r}
# Load data
data_trust_test <- readRDS("C:/Users/Redha CHABA/Documents/Working paper/Trust/Script/data/data_RDS/data_merge.rds")
bdd_geo <- read_csv("C:/Users/Redha CHABA/Documents/Working paper/Trust/Script/data/data_Raw/bdd_geo_w8.csv")
...
# List of objects to keep
objects_to_keep <- c("df_list", "data_trust_test", "murdock_sf", "unions_list")
...
ggplot() +
  ...
  theme_void() +
  geom_sf(data = selected_countries, fill = "green3", color = "black") +
    geom_point(data = selected_capitals, 
             aes(x = longitude, y = latitude), 
             size = 2, shape = 22, fill = "red", show.legend = FALSE)

#ggsave("writing/presentation/obs_map.jpg", width = 10, height = 10, units = "in", dpi = 300)
...
saveRDS(df_50, file="Data/Data_RDS/df_50_merge.rds")

write_dta(df_50, "Data/Data_dta/df_50_merge.dta")
```
...
saveRDS(df_40, file="Data/Data_RDS/df_40_merge.rds")

write_dta(df_40, "Data/Data_dta/df_40_merge.dta")
```
...
saveRDS(df_30, file="Data/Data_RDS/df_30_merge.rds")

write_dta(df_30, "Data/Data_dta/df_30_merge.dta")
```
...
saveRDS(df_25, file="Data/Data_RDS/df_25_merge.rds")

write_dta(df_25, "Data/Data_dta/df_25_merge.dta")
```
...
saveRDS(df_20, file="Data/Data_RDS/df_20_merge.rds")

write_dta(df_20, "Data/Data_dta/df_20_merge.dta")
```
...
saveRDS(df_15, file="Data/Data_RDS/df_15_merge.rds")

write_dta(df_15, "Data/Data_dta/df_15_merge.dta")
```
...
saveRDS(df_10, file="Data/Data_RDS/df_10_merge.rds")

write_dta(df_10, "Data/Data_dta/df_10_merge.dta")
```