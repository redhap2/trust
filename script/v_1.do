...
eststo ols_cty: reghdfe pol_trust dist_cap_max_norm dist_sndncap_max_norm $ind_controls $cty_controls i.round if spl==1, cluster(i.region_time)
eststo ols_fe: reghdfe pol_trust dist_cap_max_norm dist_sndncap_max_norm $ind_controls if spl==1, absorb(i.country_round) cluster(i.region_time)

use "${mypath}\data\data_dta\df_40_2.dta", clear

eststo bdd_cty: reghdfe pol_trust dist_cap_max_norm dist_sndncap_max_norm $ind_controls $cty_controls if spl==1, absorb(i.round i.murdock_names) cluster(cluster_bdd)
eststo bdd_fe: reghdfe pol_trust dist_cap_max_norm dist_sndncap_max_norm $ind_controls if spl==1, absorb(i.country_round i.murdock_names) cluster(cluster_bdd)
...
eststo ols_x_fe: reghdfe pol_trust c.dist_cap_max_norm##c.cvg_region_pot dist_sndncap_max_norm $ind_controls if spl==1, absorb(i.country_round) cluster(i.region_time)

** first stage

ivreghdfe cvg_region_pot lis_region_tv lis_region_tv_dist dist_cap_max_norm dist_sndncap_max_norm $ind_controls if spl==1 , absorb(i.country_round) cluster(region_time)
...
outreg2 lis_region_tv lis_region_tv_dist using "${mypath}\tables\v_1\t2_fs.tex",replace bdec(3) pdec(2)  tex nonotes nocons  nor2 adds(obs, e(N), boot lis_region_tv, `aux1', boot lis_region_tv_dist, `aux2') slow(700)
...
ivreghdfe cvg_region_pot_dist lis_region_tv lis_region_tv_dist dist_cap_max_norm dist_sndncap_max_norm $ind_controls i.country_round  if spl==1, cluster(region_time) 
...
outreg2 lis_region_tv lis_region_tv_dist using "${mypath}\tables\v_1\t2_fs.tex", append bdec(3) pdec(2)  tex nonotes nocons  nor2 adds(obs, e(N), boot lis_region_tv, `aux1', boot lis_region_tv_dist, `aux2', SW lis_region_tv, `SW1', SW lis_region_tv_dist, `SW2') slow(700)
...
outreg2 cvg_region_pot using "${mypath}\tables\v_1\t2_fs.tex", append bdec(3) pdec(2)  tex nonotes nocons  nor2 adds(obs, e(N), boot cvg_region_pot, `aux1') slow(700)

ivreghdfe pol_trust dist_cap_max_norm (cvg_region_pot  cvg_region_pot_dist = lis_region_tv lis_region_tv_dist)  dist_sndncap_max_norm $ind_controls if spl==1, absorb(i.country_round) cluster(region_time) endog(cvg_region_pot cvg_region_pot_dist)
...
outreg2 cvg_region_pot cvg_region_pot_dist using "${mypath}\tables\v_1\t2_fs.tex", append bdec(3) pdec(2)  tex nonotes nocons  nor2 adds(obs, e(N), boot cvg_region_pot, `aux1', boot cvg_region_pot_dist, `aux2') slow(700)

** second stage

eststo iv_fe: ivreghdfe pol_trust dist_cap_max_norm (cvg_region_pot cvg_region_pot_dist = lis_region_tv lis_region_tv_dist)  dist_sndncap_max_norm $ind_controls if spl==1, absorb(i.country_round) cluster(region_time) endog(cvg_region_pot cvg_region_pot_dist) 

estout ols_x_fe iv_fe using "${mypath}\tables\v_1\t2.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
eststo iv_fe_vote: ivreghdfe vote_oppo dist_cap_max_norm (cvg_region_pot cvg_region_pot_dist = lis_region_tv lis_region_tv_dist)  dist_sndncap_max_norm $ind_controls if spl==1, absorb(i.country_round) cluster(region_time) endog(cvg_region_pot cvg_region_pot_dist) 

eststo iv_fe_growth: ivreghdfe growth_country dist_cap_max_norm (cvg_region_pot cvg_region_pot_dist = lis_region_tv lis_region_tv_dist)  dist_sndncap_max_norm $ind_controls if spl==1, absorb(i.country_round) cluster(region_time) endog(cvg_region_pot cvg_region_pot_dist)

estout iv_fe_vote iv_fe_growth using "${mypath}\tables\v_1\t3.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
eststo iv_fe_free: ivreghdfe pol_trust dist_cap_max_norm (cvg_region_pot cvg_region_pot_dist = lis_region_tv lis_region_tv_dist)  dist_sndncap_max_norm $ind_controls if spl==1 & vdem_med_corrupt>2.57, absorb(i.country_round) cluster(region_time) endog(cvg_region_pot cvg_region_pot_dist) 

eststo iv_fe_control: ivreghdfe pol_trust dist_cap_max_norm (cvg_region_pot cvg_region_pot_dist = lis_region_tv lis_region_tv_dist)  dist_sndncap_max_norm $ind_controls if spl==1 & vdem_med_corrupt<=2.57, absorb(i.country_round) cluster(region_time) endog(cvg_region_pot cvg_region_pot_dist) 

eststo iv_fe_democ: ivreghdfe pol_trust dist_cap_max_norm (cvg_region_pot cvg_region_pot_dist = lis_region_tv lis_region_tv_dist)  dist_sndncap_max_norm $ind_controls if spl==1 & p_polity>6, absorb(i.country_round) cluster(region_time) endog(cvg_region_pot cvg_region_pot_dist) 

eststo iv_fe_autoc: ivreghdfe pol_trust dist_cap_max_norm (cvg_region_pot cvg_region_pot_dist = lis_region_tv lis_region_tv_dist)  dist_sndncap_max_norm $ind_controls if spl==1 & p_polity<=6, absorb(i.country_round) cluster(region_time) endog(cvg_region_pot cvg_region_pot_dist) 

estout iv_fe_free iv_fe_control iv_fe_democ iv_fe_autoc using "${mypath}\tables\v_1\t4.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
estout educ_low educ_high urban rural using "${mypath}\tables\v_1\t5.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
estout ols_int_news_cty ols_int_news_fe ols_int_use_cty ols_int_use_fe using "${mypath}\tables\v_1\A1.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
estout ols_cty ols_fe bdd_cty bdd_fe using "${mypath}\tables\v_1\A2.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
estout ols_cty ols_fe bdd_cty bdd_fe using "${mypath}\tables\v_1\A3.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
estout ols_cty ols_fe bdd_cty bdd_fe using "${mypath}\tables\v_1\A4.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
estout ols_cty ols_fe bdd_cty bdd_fe using "${mypath}\tables\v_1\A5.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
estout ols_cty ols_fe bdd_cty bdd_fe using "${mypath}\tables\v_1\A6.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
estout ols_cty ols_fe bdd_cty bdd_fe using "${mypath}\tables\v_1\A7.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
estout bdd_cty_30 bdd_fe_30 bdd_cty_50 bdd_fe_50 using "${mypath}\tables\v_1\A8.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
estout ols_cty ols_fe bdd_cty bdd_fe using "${mypath}\tables\v_1\A9.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
estout ols_cty ols_fe bdd_cty bdd_fe using "${mypath}\tables\v_1\A10.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
estout ols_cty ols_fe bdd_cty bdd_fe using "${mypath}\tables\v_1\A11.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
estout ols_cty ols_fe bdd_cty bdd_fe using "${mypath}\tables\v_1\A12.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
estout ols_cty ols_fe bdd_cty bdd_fe using "${mypath}\tables\v_1\A13.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
estout ols_cty ols_fe bdd_cty bdd_fe using "${mypath}\tables\v_1\A14.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend
...
estout ols_cty ols_fe bdd_cty bdd_fe using "${mypath}\tables\v_1\A15.tex", replace style(tex) cells(b(star fmt(3)) se(par fmt(2))) starlevels(* 0.10 ** 0.05 *** 0.01) stats(N r2_a, fmt(0 3)) margin legend