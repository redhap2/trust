...
#Share of the region’s population with potential access to 3G
...
saveRDS(ggg_r5_adm1, file="data/data_rds/ggg_r5_adm1_bis.rds")
```
...
saveRDS(ggg_r5_adm2, file="data/data_rds/ggg_r5_adm2_bis.rds")
```
...
saveRDS(ggg_r5_adm3, file="data/data_rds/ggg_r5_adm3_bis.rds")
```

###adm_merge

```{r}
ggg_r5_adm1 <- readRDS("data/data_rds/ggg_r5_adm1_bis.rds")
ggg_r5_adm2 <- readRDS("data/data_rds/ggg_r5_adm2_bis.rds")
ggg_r5_adm3 <- readRDS("data/data_rds/ggg_r5_adm3_bis.rds")
...
saveRDS(ggg_r5, file="data/data_rds/ggg_r5_bis.rds")
```
...
saveRDS(ggg_r6_adm1, file="data/data_rds/ggg_r6_adm1_bis.rds")
```
...
saveRDS(ggg_r6_adm2, file="data/data_rds/ggg_r6_adm2_bis.rds")
...
saveRDS(ggg_r6_adm3, file="data/data_rds/ggg_r6_adm3_bis.rds")
```

###adm_merge

```{r}
ggg_r6_adm1 <- readRDS("data/data_rds/ggg_r6_adm1_bis.rds")
ggg_r6_adm2 <- readRDS("data/data_rds/ggg_r6_adm2_bis.rds")
ggg_r6_adm3 <- readRDS("data/data_rds/ggg_r6_adm3_bis.rds")
...
saveRDS(ggg_r6, file="data/data_rds/ggg_r6_bis.rds")
```
...
saveRDS(ggg_r7_adm1, file="data/data_rds/ggg_r7_adm1_bis.rds")
```
...
saveRDS(ggg_r7_adm2, file="data/data_rds/ggg_r7_adm2_bis.rds")
```
...
saveRDS(ggg_r7_adm3, file="data/data_rds/ggg_r7_adm3_bis.rds")
```

###adm_merge

```{r}
ggg_r7_adm1 <- readRDS("data/data_rds/ggg_r7_adm1_bis.rds")
ggg_r7_adm2 <- readRDS("data/data_rds/ggg_r7_adm2_bis.rds")
ggg_r7_adm3 <- readRDS("data/data_rds/ggg_r7_adm3_bis.rds")
...
saveRDS(ggg_r7, file="data/data_rds/ggg_r7_bis.rds")
```
...
saveRDS(ggg_r8_adm1, file="data/data_rds/ggg_r8_adm1_bis.rds")
```
...
saveRDS(ggg_r8_adm2, file="data/data_rds/ggg_r8_adm2_bis.rds")
```
...
saveRDS(ggg_r8_adm3, file="data/data_rds/ggg_r8_adm3_bis.rds")
```

###adm_merge

```{r}
ggg_r8_adm1 <- readRDS("data/data_rds/ggg_r8_adm1_bis.rds")
ggg_r8_adm2 <- readRDS("data/data_rds/ggg_r8_adm2_bis.rds")
ggg_r8_adm3 <- readRDS("data/data_rds/ggg_r8_adm3_bis.rds")
...
saveRDS(ggg_r8, file="data/data_rds/ggg_r8_bis.rds")
```

```{r}
ggg_r5 <- readRDS("data/data_rds/ggg_r5_bis.rds")
ggg_r6 <- readRDS("data/data_rds/ggg_r6_bis.rds")
ggg_r7 <- readRDS("data/data_rds/ggg_r7_bis.rds")
ggg_r8 <- readRDS("data/data_rds/ggg_r8_bis.rds")

ggg_rounds <- list(ggg_r5, ggg_r6, ggg_r7, ggg_r8)

ggg_stack <- bind_rows(ggg_rounds)

saveRDS(ggg_stack, file="data/data_rds/ggg_stack_bis.rds")
```
...
#Share of the region’s population with potential access to 2G
...
saveRDS(gg_r5_adm1, file="data/data_rds/gg_r5_adm1_bis.rds")
```
...
saveRDS(gg_r5_adm2, file="data/data_rds/gg_r5_adm2_bis.rds")
```
...
saveRDS(gg_r5_adm3, file="data/data_rds/gg_r5_adm3_bis.rds")
```

###adm_merge

```{r}
gg_r5_adm1 <- readRDS("data/data_rds/gg_r5_adm1_bis.rds")
gg_r5_adm2 <- readRDS("data/data_rds/gg_r5_adm2_bis.rds")
gg_r5_adm3 <- readRDS("data/data_rds/gg_r5_adm3_bis.rds")
...
saveRDS(gg_r5, file="data/data_rds/gg_r5_bis.rds")
```
...
saveRDS(gg_r6_adm1, file="data/data_rds/gg_r6_adm1_bis.rds")
```
...
saveRDS(gg_r6_adm2, file="data/data_rds/gg_r6_adm2_bis.rds")
```
...
saveRDS(gg_r6_adm3, file="data/data_rds/gg_r6_adm3_bis.rds")
```

###adm_merge

```{r}
gg_r6_adm1 <- readRDS("data/data_rds/gg_r6_adm1_bis.rds")
gg_r6_adm2 <- readRDS("data/data_rds/gg_r6_adm2_bis.rds")
gg_r6_adm3 <- readRDS("data/data_rds/gg_r6_adm3_bis.rds")
...
saveRDS(gg_r6, file="data/data_rds/gg_r6_bis.rds")
...
saveRDS(gg_r7_adm1, file="data/data_rds/gg_r7_adm1_bis.rds")
```
...
saveRDS(gg_r7_adm2, file="data/data_rds/gg_r7_adm2_bis.rds")
```
...
saveRDS(gg_r7_adm3, file="data/data_rds/gg_r7_adm3_bis.rds")
```

###adm_merge

```{r}
gg_r7_adm1 <- readRDS("data/data_rds/gg_r7_adm1_bis.rds")
gg_r7_adm2 <- readRDS("data/data_rds/gg_r7_adm2_bis.rds")
gg_r7_adm3 <- readRDS("data/data_rds/gg_r7_adm3_bis.rds")
...
saveRDS(gg_r7, file="data/data_rds/gg_r7_bis.rds")
```
...
saveRDS(gg_r8_adm1, file="data/data_rds/gg_r8_adm1_bis.rds")
```
...
saveRDS(gg_r8_adm2, file="data/data_rds/gg_r8_adm2_bis.rds")
```
...
saveRDS(gg_r8_adm3, file="data/data_rds/gg_r8_adm3_bis.rds")
```

###adm_merge

```{r}
gg_r8_adm1 <- readRDS("data/data_rds/gg_r8_adm1_bis.rds")
gg_r8_adm2 <- readRDS("data/data_rds/gg_r8_adm2_bis.rds")
gg_r8_adm3 <- readRDS("data/data_rds/gg_r8_adm3_bis.rds")
...
saveRDS(gg_r8, file="data/data_rds/gg_r8_bis.rds")
```

```{r}
gg_r5 <- readRDS("data/data_rds/gg_r5_bis.rds")
gg_r6 <- readRDS("data/data_rds/gg_r6_bis.rds")
gg_r7 <- readRDS("data/data_rds/gg_r7_bis.rds")
gg_r8 <- readRDS("data/data_rds/gg_r8_bis.rds")

gg_rounds <- list(gg_r5, gg_r6, gg_r7, gg_r8)

gg_stack <- bind_rows(gg_rounds)

saveRDS(gg_stack, file="data/data_rds/gg_stack_bis.rds")
```

##Merge internet

```{r}
gg_stack <- readRDS("data/data_rds/gg_stack_bis.rds")
ggg_stack <- readRDS("data/data_rds/ggg_stack_bis.rds")

int_stack_bis <- gg_stack %>%
  left_join(ggg_stack, by = c("iso", "NAME_1", "NAME_2", "NAME_3", "round"))

saveRDS(int_stack_bis, file="data/data_rds/int_stack_bis.rds")

int_stack_bis <- readRDS("data/data_rds/int_stack_bis.rds")
...
data_final_nlp_bis <- readRDS("data/data_rds/data_final_nlp.rds")

data_final_nlp_bis%<>%
  select(-c("gg_pop_adm1","gg_adm1","gg_adm1_pot","gg_pop_adm2","gg_adm2","gg_adm2_pot","gg_pop_adm3","gg_adm3","gg_adm3_pot","ggg_pop_adm1","ggg_adm1","ggg_adm1_pot","ggg_pop_adm2","ggg_adm2","ggg_adm2_pot","ggg_pop_adm3","ggg_adm3","ggg_adm3_pot","pop_adm1","pop_adm2","pop_adm3", "gg_region_pot", "ggg_region_pot", "cvg_region_pot", "cvg_region_pot_2")) 

data_final_nlp_bis %<>%
  left_join(int_stack_bis, by = c("iso", "NAME_1", "NAME_2", "NAME_3", "round"))

data_final_nlp_bis%<>%
mutate(gg_region_pot = case_when(
    iso %in% c("GHA","KEN","MOZ", "MWI","NGA","TZA","UGA","ZMB", "ZWE") ~ gg_adm1_pot,
    iso %in%  c("BEN", "BFA", "BWA", "CIV", "CMR", "GIN", "LBR", "MLI", "NAM", "NER", "SLE") ~ gg_adm2_pot, 
    TRUE ~ NA_integer_
  ))%>%
mutate(ggg_region_pot = case_when(
    iso %in% c("GHA","KEN","MOZ", "MWI","NGA","TZA","UGA","ZMB", "ZWE") ~ ggg_adm1_pot,
    iso %in%  c("BEN", "BFA", "BWA", "CIV", "CMR", "GIN", "LBR", "MLI", "NAM", "NER", "SLE") ~ ggg_adm2_pot, 
    TRUE ~ NA_integer_))%>%
  mutate(cvg_region_pot=ifelse(is.na(ggg_region_pot), gg_region_pot, ggg_region_pot))


data_final_nlp_bis <- readRDS("data/data_rds/data_final_nlp_bis.rds")

data_final_nlp_bis%<>%
mutate(pop_region = case_when(
    iso %in% c("GHA","KEN","MOZ", "MWI","NGA","TZA","UGA","ZMB", "ZWE") ~ pop_adm1,
    iso %in% c("BEN", "BFA", "BWA", "CIV", "CMR", "GIN", "LBR", "MLI", "NAM", "NER", "SLE") ~ pop_adm2, 
    TRUE ~ NA_integer_
  ))%>%
...
data_final_nlp_bis2%<>%
  ...
  mutate(adm1_time = case_when(
    iso %in% c("BEN", "BFA", "BWA", "CIV", "CMR", "GIN", "LBR", "MLI", "NAM", "NER", "SLE") ~ name1_id * 10000 + round,
    TRUE ~ NA_integer_
  ))%>%
mutate(adm1_time = as.integer(as.factor(adm1_time)))%>%
mutate(adm2_time = case_when(
    iso %in% c("GHA","KEN","MOZ", "MWI","NGA","TZA","UGA","ZMB", "ZWE") ~ name2_id * 10000 + round,
    TRUE ~ NA_integer_
  ))%>%
mutate(adm2_time = as.integer(as.factor(adm2_time)))
  ...
  mutate(region_time = case_when(
    iso %in%c("BEN", "BFA", "BWA", "CIV", "CMR", "GIN", "LBR", "MLI", "NAM", "NER", "SLE") ~ name2_id * 10000 + round, 
    iso %in% c("GHA","KEN","MOZ", "MWI","NGA","TZA","UGA","ZMB", "ZWE") ~ name1_id * 10000 + round,
    TRUE ~ NA_integer_
  ))%>%
...
saveRDS(data_final_nlp_bis, file="data/data_rds/data_final_nlp_bis.rds")
write_dta(data_final_nlp_bis, "data/data_dta/data.dta")
```
...
```{r}
data_final_int <- readRDS("data/data_rds/data_final_nlp_bis.rds")
...
```{r}
data_final_nlp_bis <- readRDS("data/data_rds/data_final_int_n_l.rds")

countries <- c("BEN", "BFA", "BWA", "CMR", "CIV", "GIN", "LBR", "MLI", "NAM", "NER", "SLE", "GHA", "KEN", "MOZ", "MWI", "NGA", "TZA", "UGA", "ZMB", "ZWE")

data_keep <- subset(data_final_nlp_bis, select = c("id_unique", "latitude", "longitude")) %>%
  filter(!is.na(latitude) & !is.na(longitude))
...
data_final_nlp_bis2 %<>% left_join(data_area_region, by=c("iso", "NAME_1", "NAME_2", "NAME_3"))%>%
  distinct(id_unique, .keep_all = TRUE)

saveRDS(data_final_nlp_bis2, file="data/data_rds/data_final_nlp_bis2.rds")
```

#Various variable creation

```{r}
data_final_nlp_bis2 <- readRDS("data/data_rds/data_final.rds")
...
data_final_nlp_bis2 %<>% left_join(results, by=c("iso", "round"))
...
data_final_nlp_bis2 %<>% left_join(data_color, by="iso")
rm(data_color)
...
juriglobe %<>%
  ...
  mutate(
    gov_type = case_when(
      gov_type == "Présidentiel" ~ "presidential",
      gov_type == "Parlementaire" ~ "parliamentarian",
      gov_type == "Semi-présidentiel" ~ "semi_presidential",
...
data_final_nlp_bis2 %<>% left_join(juriglobe, by="iso")
...
data_final_nlp_bis2 %<>% left_join(var_cty, by = "iso")
...
countries <- unique(data_final_nlp_bis2$iso)
...
data_final_nlp_bis2 %<>% left_join(qog, by=c("iso", "round"))
...
data_final_nlp_bis2%<>%select(-sex)
...
data_final_nlp_bis2%<>%select(-c("rural", "bin_rural"))
...
data_final_nlp_bis2 <- left_join(data_final_nlp_bis2, afro_w8, by="id_unique")
...
data_final_nlp_bis2 <- left_join(data_final_nlp_bis2, afro_w7, by="id_unique")
...
data_final_nlp_bis2 <- left_join(data_final_nlp_bis2, afro_w6, by="id_unique")
...
data_final_nlp_bis2 <- left_join(data_final_nlp_bis2, afro_w5, by="id_unique")
...
data_final_nlp_bis2 %<>% left_join(data_elections_R, by=c("iso","round"))

data_final_nlp_bis2$vote_party <- as.numeric(zap_labels(data_final_nlp_bis2$vote_party))

data_final_nlp_bis2$vote_oppo <- ifelse(data_final_nlp_bis2$winner!=data_final_nlp_bis2$vote_party, 1,0)
```
...
data_final_nlp_bis2 <- readRDS("data/data_rds/data_final_r.rds")
...
```{r}
table(data_final_nlp_bis2$neig_eth_a)
hist(data_final_nlp_bis2$neig_eth_a)
```

#Export Stata

```{r}
saveRDS(data_final_nlp_bis2, file="data/data_rds/data_final_r.rds")

write_dta(data_final_nlp_bis2, "data/data_dta/data_final_r.dta")
```
